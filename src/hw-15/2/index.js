...
function SeparateStore() {
  this.tasks = [];
}

/////////////////////////НАЧАЛО ПРАВОК КЛАССА Developer/////////////////////////
function Developer() {
  SeparateStore.apply(this, arguments);
}

// Ingerit all behavior from SeparateStore
Developer.prototype = Object.create(SeparateStore.prototype);
Developer.prototype.constructor = Developer;

// Developer.prototype.tasks = []; // central store tasks. But should be separate stores, for each exemplar
...
form.onsubmit = (event) => {
  ...
  if (!task.trim()) {
    throw new Error("It's not correct task");
  }
